...
install: build
	...
	@# Install skills for both harnesses (claude hooks; cursor is skill-only).
	@./$(BINARY) skill install --force --harness claude
	@./$(BINARY) skill install --force --harness cursor --skip-hook
	@echo ""
